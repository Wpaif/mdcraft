...
use crate::app::placeholder;
use crate::app::price::paint_price_status;
use super::super::npc_price::{
        ...
        egui::Frame::NONE
            ...
            .show(ui, |ui| {
                ...
                let longest_name_chars = indices_precificaveis
                    ...
                    .max()
                    .unwrap_or(10);
                let preferred_item_w =
                    (longest_name_chars as f32 * 8.0 + 20.0).clamp(120.0, 360.0);
                                        ...
                                        for row in 0..rows {
                                            for col in 0..column_count {
                                                ...
                                                if idx < indices_precificaveis.len() {
                                                    ...
                                                    let stroke =
                                                        price_input_stroke(ui, item, &npc_lookup);
                                                    ...
                                                    let (item_total, should_autosave_recipe) = {
                                                        apply_item_price_if_changed(
                                                            item,
                                                            price_changed,
                                                        );
                                                        let mut should_autosave_recipe =
                                                            price_changed;
                                                        ...
                                                        let npc_price =
                                                            npc_price_for_item(item, &npc_lookup);
                                                        ...
                                                        ui.allocate_ui_with_layout(
                                                            ...
                                                            |ui| {
                                                                if should_show_npc_price_icon(
                                                                    &item.nome,
                                                                ) {
                                                                    let npc_resp =
                                                                        paint_npc_price_icon(
                                                                            ui,
                                                                            npc_price.is_some(),
                                                                            npc_equal,
                                                                        );
                                                        ...
                                                        (item.valor_total, should_autosave_recipe)
                                                    };
                                                    ...
                                                    *total_cost += item_total;
                                                    ...
                                                    render_empty_item_cells(
                                                        ui, item_w, qty_w, price_w, total_w,
                                                        status_w,
                                                    );
                                                }
                                            }
