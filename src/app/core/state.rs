...
pub struct MdcraftApp {
    ...
    pub craft_search_qty_input: String,
    pub items: Vec<Item>,
    ...
    pub craft_refresh_in_progress: bool,
    pub craft_refresh_rx: Option<Receiver<Result<Vec<ScrapedCraftRecipe>, String>>>,
...
impl Default for MdcraftApp {
    fn default() -> Self {
        ...
        Self {
            ...
            craft_search_qty: 1,
            craft_search_qty_input: "1".to_string(),
            items: Vec::new(),
            ...
            craft_refresh_in_progress: false,
            craft_refresh_rx: None,
