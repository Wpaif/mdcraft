...
mod tests {
    use super::{
        CraftProfession, CraftRank, ScrapedItem, WikiSource, clean_cell_text,
        embedded_resource_names, embedded_wiki_items, extract_ingredients_from_materials_cell,
        ...
        parse_profession_crafts_from_html,
    };
